                    ...
                    <div className="main-header">
                        <div className="header-logo">
                            <Link className="d-flex" href="/">
                                <Image width={100} height={100} className="logo-night" alt="GenZ" src="/assets/imgs/cupi/cupi.png" />
                                <Image width={100} height={100} className="d-none logo-day" alt="GenZ" src="/assets/imgs/cupi/cupi.png" />
                            </Link>
                        </div>
